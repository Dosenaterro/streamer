    document.addEventListener('DOMContentLoaded', function() {
        ...
        const noMois = localStorage.getItem('mois');
        const noEcran = localStorage.getItem('ecran');
        const noPrix = localStorage.getItem('prix');

        const selectedEcran = localStorage.getItem('selectedEcran');
        const selectedType = localStorage.getItem('selectedType');
        
        const montant = document.getElementById('montant');
        montant.textContent = noPrix;

        const nMois = document.getElementById('nMois');
        nMois.textContent = noMois;

        const nEcran = document.getElementById('nEcran');
        nEcran.textContent = noEcran;
        ...
        function expiration(months) {
            ...
            finDate.setMonth(today.getMonth() + parseInt(noMois));
        ...
        if (titre) {
            ...
            titreElement.textContent = titre.toUpperCase();
        }
