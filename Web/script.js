...
function setCaracVid() {
    deux = '1 mois sur 1 écran';
    trois = '1 mois sur 2 écrans';
    quatre = '2 mois sur 1 écran';
    cinq = '2 mois sur 2 écrans';
    cinq5 = '3 mois sur 1 écran';
    six5 = '3 mois sur 2 écrans';
    neuf = '5 mois sur 1 écran';
    dix = '5 mois sur 2 écrans';
    onze = '6 mois sur 1 écran';
    treize = '6 mois sur 2 écrans';
    v5 = '12 mois sur 1 écran';
    v7 = '12 mois sur 2 écrans';
}
setCaracVid();
...
/* Configuration des bouttons de navigation Retour et Suivant */
function retour() {
    window.history.back();
}
function suivant() {
...
// Select all elements with class 'netflix'
const netTitres = document.querySelectorAll('.netflix');

// Add click event listener to each Netflix element
netTitres.forEach(netTitre => {
    netTitre.addEventListener('click', function() {
        localStorage.setItem('netTitre', netTitre);
    });
});

// Select all elements with class 'spotify'
const spotTitres = document.querySelectorAll('.spotify');

// Add click event listener to each Spotify element
spotTitres.forEach(spotTitre => {
    spotTitre.addEventListener('click', function() {
        localStorage.setItem('spotTitre', spotTitre);
    });
});
